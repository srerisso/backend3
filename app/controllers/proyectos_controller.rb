class ProyectosController < ApplicationController
  ...
  def index
    @proyectos = Proyecto.order(Codigo_Alg: :desc).page params[:page]
  end
  ...
  private
    ...
    def proyecto_params
      params.require(:proyecto).permit(:Referencia, :cliente_id, :published_at, :created_by, :updated_by, :Codigo_Alg, :Estado, :cliente)
    end
end
