...
class PersonasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create persona" do
    assert_difference('Persona.count') do
      post personas_url, params: { persona: { empresa: @persona.empresa, name: @persona.name } }
    end
  ...
  test "should update persona" do
    patch persona_url(@persona), params: { persona: { empresa: @persona.empresa, name: @persona.name } }
